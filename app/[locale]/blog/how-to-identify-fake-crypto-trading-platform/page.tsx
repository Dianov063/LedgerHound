...
const tocItems = [
  ...
  { id: 'how-they-work', label: 'How Fake Platforms Work' },
  { id: 'warning-signs', label: '10 Warning Signs' },
  { id: 'technical-red-flags', label: 'Technical Red Flags' },
  { id: 'real-case', label: 'Real Case: $164,000 Lost' },
  { id: 'already-sent', label: 'If You\'ve Already Sent Money' },
...
export default function FakeTradingPlatformArticle() {
      ...
      <div className="pt-28 pb-12 bg-gradient-to-br from-slate-50 to-white border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-1.5 text-xs text-slate-400 mb-8">
            ...
            <ChevronRight size={12} />
            <span className="text-slate-600">Fake Crypto Platforms</span>
          </nav>
