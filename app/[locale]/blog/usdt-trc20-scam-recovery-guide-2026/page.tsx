...
const tocItems = [
  { id: 'scam-landscape', label: 'TRC20 Scam Landscape in 2026' },
  { id: 'first-72-hours', label: 'The Critical First 72 Hours' },
  { id: 'forensic-investigation', label: 'Forensic Investigation Phase' },
  { id: 'legal-pathways', label: 'Legal Pathways & Recovery' },
  { id: 'avoiding-recovery-scams', label: 'Avoiding Recovery Scams' },
  { id: 'getting-help', label: 'Getting Professional Help' },
];

const CURRENT_SLUG = 'usdt-trc20-scam-recovery-guide-2026';
...
export default function UsdtTrc20ScamArticle() {
  ...
  const shareTitle = 'USDT TRC20 Scam Recovery Guide 2026: A Forensic Roadmap';
      ...
      <div className="pt-32 pb-12 bg-gradient-to-br from-slate-50 to-white border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-1.5 text-xs text-slate-400 mb-8">
            ...
            <ChevronRight size={12} />
            <span className="text-slate-600">USDT TRC20 Scam Recovery</span>
          </nav>
